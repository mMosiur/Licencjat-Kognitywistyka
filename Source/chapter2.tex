...
\begin{table}[ht]
	\begin{center}
		\begin{tabular}{  c | c | c   }
			\hline
			Moduł & Liczba węzłów & Liczba podmodułów \\
			\hline
			\hline
	...
	Przedstawia ilość węzłów znajdujących się wewnątrz każdego z~największych modułów najwyższego poziomu hierarchii oraz ilość znajdujących się w~nich podmodułów.
	\label{tab:modular}
\end{table}
...
Zawarte w~module centralnym kora przyśrodkowa oraz kora boczna znalazły się bowiem w~osobnych podmodułach.
